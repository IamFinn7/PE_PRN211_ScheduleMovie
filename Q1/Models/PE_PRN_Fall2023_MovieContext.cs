...
namespace Q1.Models
{
    public partial class PE_PRN_Fall2023_MovieContext : DbContext
    {
        public PE_PRN_Fall2023_MovieContext()
        {
        }

        public PE_PRN_Fall2023_MovieContext(DbContextOptions<PE_PRN_Fall2023_MovieContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server =(local); database = PE_PRN_Fall2023_Movie;uid=sa;pwd=iamfinn7;TrustServerCertificate=true;Trusted_Connection=SSPI;Encrypt=false;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Movie>(entity =>
            {
                ...
                entity.HasMany(d => d.Genres)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            j.HasKey("MovieId", "GenreId").HasName("PK__Movie_Ge__BBEAC44D91D396A6");
            ...
            modelBuilder.Entity<MovieStar>(entity =>
            {
                entity.HasKey(e => new { e.MovieId, e.StarId })
                    .HasName("PK__Movie_St__2BB8287CDC8C45C8");
